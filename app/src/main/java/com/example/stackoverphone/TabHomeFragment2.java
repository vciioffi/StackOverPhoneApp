 ...
 * Use the {@link TabHomeFragment2#newInstance} factory method to
...
public class TabHomeFragment2 extends Fragment {
     ...
     * @return A new instance of fragment TabHomeFragment2.
     */
    // TODO: Rename and change types and number of parameters
    public static TabHomeFragment2 newInstance(String param1, String param2) {
        TabHomeFragment2 fragment = new TabHomeFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* lista = new ArrayList<>();
        ...
        v = inflater.inflate(R.layout.fragment_tab_home2,container,false);
        ...
        FirebaseRecyclerOptions<Question> options =
                new FirebaseRecyclerOptions.Builder<Question>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Question").orderByChild("puntuacion"),Question.class)
                        .build();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        list.add(new DatosRV("hola","hola","1"));
                        list.add(new DatosRV(qst.getTitulo(), qst.getPregunta(), qst.getCodigo()));
                    }
